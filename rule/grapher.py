...
class Grapher(object):
    ...
    # def get_data2idx(self):
    #     self.create_store("train.txt")  # 既包含正向的边，又包含所有的逆向的边，r>230都是逆向
    #     self.create_store("valid.txt")
    #     self.create_store("test.txt")
    #
    ...
    #     with open(self.dataset_dir + data_file + "2id.txt", "w") as f2:
    #         for line in store_idx:
